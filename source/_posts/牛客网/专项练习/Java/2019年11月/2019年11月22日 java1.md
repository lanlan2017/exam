...
- [题目4](/exam/null/#题目4)
    - [解析](/exam/null/#解析)
        - [多态 编译看左边 运行看右边](/exam/null/#多态-编译看左边-运行看右边)
- [题目5](/exam/null/#题目5)
    - [解析](/exam/null/#解析)
        - [内部类分类](/exam/null/#内部类分类)
        - [1.成员内部类](/exam/null/#1-成员内部类)
        - [2.局部内部类](/exam/null/#2-局部内部类)
        - [3.匿名内部类](/exam/null/#3-匿名内部类)
- [题目6](/exam/null/#题目6)
    - [解析](/exam/null/#解析)
        - [优化Hibernate所鼓励的7大措施](/exam/null/#优化Hibernate所鼓励的7大措施)
